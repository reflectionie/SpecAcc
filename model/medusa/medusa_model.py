    ...
    def from_pretrained(
        ...
        **kwargs,
        ...
        try:
            ...
            # TODO: fix the uploaded config (only include 2 heads)
            ...
            if os.path.exists(medusa_head_path):
                ...
                filename = hf_hub_download(
                    pretrained_model_name_or_path, "medusa_lm_head.pt")
            medusa_head_state_dict = torch.load(
                filename, map_location=model.device)
            model.medusa_head.load_state_dict(
                medusa_head_state_dict, strict=False)
            return model
