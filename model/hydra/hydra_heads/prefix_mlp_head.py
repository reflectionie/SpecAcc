...
from ..modeling_llama_kv import LlamaModel
...
class HydraPrefixMLP(nn.Module):
    ...
    def proposal(
        ...
        # elif self.ensemble_heads:   # TODO 
        #     return self._ensemble_proposal(input_logits, base_hidden_states, hydra_buffers, past_key_values)
        else:
